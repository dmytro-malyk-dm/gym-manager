...
class ClientRegistrationFormTest(TestCase):
    ...
    def test_invalid_phone_number_format(self):
        ...
        data = {
            ...
            'password1': 'testpass123',
            'password2': 'testpass123',
            'phone_number': '0501234567'  # Missing +380
        }
        form = ClientRegistrationForm(data=data)
    ...
    def test_phone_number_wrong_length(self):
        ...
        data = {
            ...
            'password1': 'testpass123',
            'password2': 'testpass123',
            'phone_number': '+38050123456'  # Too short
        }
        form = ClientRegistrationForm(data=data)
        self.assertFalse(form.is_valid())
...
class ScheduleFormTest(TestCase):
    def setUp(self):
        ...
        # Create specialization and trainer profile
    ...
    def test_trainer_can_only_see_own_workouts(self):
        ...
        # Create another trainer with their workout
        ...
        # Form for trainer1 should only show their workout
    ...
    def test_admin_can_see_all_workouts(self):
        ...
        # Form for admin should show all workouts
