...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        specializations = ['Yoga', 'CrossFit', 'Boxing', 'Pilates', 'HIIT', 'Strength Training']
        spec_objects = []
        ...
        schedule_templates = [
            {'workout': workouts[0], 'hour': 7, 'capacity': 15, 'days': [1, 3, 5]},  # Morning Yoga - Mon, Wed, Fri
            {'workout': workouts[1], 'hour': 10, 'capacity': 12, 'days': [2, 4]},  # Power Yoga - Tue, Thu
            {'workout': workouts[2], 'hour': 18, 'capacity': 20, 'days': [1, 3, 5]},  # CrossFit Fundamentals
            {'workout': workouts[3], 'hour': 19, 'capacity': 10, 'days': [2, 4, 6]},  # Advanced CrossFit
            {'workout': workouts[4], 'hour': 17, 'capacity': 15, 'days': [1, 3, 5]},  # Boxing
            {'workout': workouts[5], 'hour': 20, 'capacity': 20, 'days': [1, 2, 3, 4, 5]},  # Evening Stretch
        ]
